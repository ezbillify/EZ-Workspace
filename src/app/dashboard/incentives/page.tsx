    ...
    <DashboardShell title="My Incentives">
      ...
      {summary && (
        <div className="mb-6 grid grid-cols-2 gap-4 sm:grid-cols-5">
          {[
            { label: "Total Earned", value: summary.total_earned, color: "text-gray-800 dark:text-gray-100" },
      ...
      <Card>
        ...
        {loading ? (
          ...
          <div className="py-12 text-center text-sm text-gray-400">No incentives yet</div>
        ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl dark:bg-gray-900">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h3 className="font-bold text-gray-900 dark:text-white">Hold Bonus Calculator</h3>
            </div>
              ...
              {[
                ...
                <div
                  ...
                  className={`flex items-center justify-between rounded-lg px-4 py-3 ${
                    highlight ? "bg-emerald-50 dark:bg-emerald-900/20" : "bg-gray-50 dark:bg-gray-800"
                  }`}
                >
                  <span className="text-sm text-gray-700 dark:text-gray-300">{label}</span>
                  <span className={`font-bold ${highlight ? "text-emerald-600" : "text-gray-800 dark:text-gray-100"}`}>
            ...
            <p className="mb-4 text-xs text-gray-400">If you wait 2 months, your incentive becomes{" "}
