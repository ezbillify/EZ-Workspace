    ...
    <DashboardShell title="Reimbursements">
      ...
      <Card>
        ...
        {loading ? (
          ...
          <div className="py-12 text-center text-sm text-gray-400">No reimbursement requests yet.</div>
        ) : (
              ...
              <tbody className="divide-y divide-gray-50 dark:divide-gray-700/50">
                {items.map((item) => (
                  <tr key={item._id}>
                    ...
                    <td className="py-3 pr-4 capitalize text-gray-500">{item.category}</td>
